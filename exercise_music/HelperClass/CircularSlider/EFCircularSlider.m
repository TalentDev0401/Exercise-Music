...
-(BOOL) beginTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    JukeBoxUtils *util = [[JukeBoxUtils alloc]init];
    [util playPauseAction];
    return YES;
}
...
-(void)moveHandle:(CGPoint)point {
    ...
    [self setNeedsDisplay];
//    JukeBoxUtils *util = [[JukeBoxUtils alloc]init];
    [[JukeBoxUtils sharedInstance] progressSliderValueChangedWithValue:_currentValue/100];
}
- (CGPoint)centerPoint {
